...
/* General */
val DEVICE_NAME = "${Build.MANUFACTURER} ${Build.MODEL}, Android ${Build.VERSION.RELEASE} (${Build.VERSION.SDK_INT})"
const val TERMINAL_DATA_RENEWAL_MINUTES_INTERVAL: Long = 30
